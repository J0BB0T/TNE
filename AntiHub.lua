	...
	Converted["_UICorner7"].Parent = Converted["_Clear"]
	...
	Converted["_UICorner8"].Parent = Converted["_AWL"]
	...
	Converted["_Input1"].PlaceholderText = "Username Here"
	...
	Converted["_Input1"].Position = UDim2.new(0.200000003, 0, 0.899999976, 0)
	Converted["_Input1"].Size = UDim2.new(0.25, 0, 0.150000006, 0)
	Converted["_Input1"].Name = "Input"
	Converted["_Input1"].Parent = Converted["_AntiCheat1"]
	...
	Converted["_UICorner10"].Parent = Converted["_ACToggle"]
	...
	Converted["_UICorner11"].Parent = Converted["_ToastToggle"]
	...
	Converted["_Key"].Position = UDim2.new(0.5, 0, 0.912500024, 0)
	Converted["_Key"].Size = UDim2.new(0.649999976, 0, 0.125, 0)
	Converted["_Key"].Name = "Key"
	Converted["_Key"].Parent = Converted["_Players2"]

	Converted["_UICorner12"].CornerRadius = UDim.new(0.0149999997, 0)
	Converted["_UICorner12"].Parent = Converted["_TitleBar"]
	...
	Converted["_UICorner13"].Parent = Converted["_Title"]
	...
	Converted["_UICorner14"].Parent = Converted["_Close"]
